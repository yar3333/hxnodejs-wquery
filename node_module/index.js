...
wquery_Application.getTemplate = function(klass) {
	if(wquery_Application.templates.h.__keys__[klass.__id__] == null) {
...
var wquery_Component = $hx_exports["Component"] = function(parent,parentNode,params,attachMode) {
	...
	if(parent != null) {
		if(Object.prototype.hasOwnProperty.call(parent.children,this.id)) {
			throw new Error("Component '" + wquery_ComponentTools.getClassName(parent == null ? null : js_Boot.getClass(parent)) + "#" + parent.id + "': child component with id = '" + this.id + "' already exist.");
		}
...
wquery_ComponentTools.processSubstitution = function(s,object) {
	return new EReg("\\{([_a-zA-Z][_a-zA-Z0-9]*)\\}","g").map(s,function(re) {
		...
		if(!Object.prototype.hasOwnProperty.call(object,name)) {
			throw new js__$Boot_HaxeError(new wquery_ComponentInitializationException("Don't found field for substitution '" + name + "'"));
		}
