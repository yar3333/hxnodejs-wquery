...
$hx_exports["wquery"] = $hx_exports["wquery"] || {};
...
var wquery_Application = $hx_exports["wquery"]["Application"] = function() { };
...
var wquery_Component = $hx_exports["wquery"]["Component"] = function(parent,parentNode,params,attachMode) {
	this.nextAnonimID = 0;
	this.children = { };
	this.id = "";
...
var wquery_ComponentInitializationException = $hx_exports["wquery"]["ComponentInitializationException"] = function(message) {
	this.message = message;
};
...
var wquery_ComponentList = $hx_exports["wquery"]["ComponentList"] = function(type,parentComponent,parentNode,paramsList) {
	this.length = 0;
	this.components = [];
	this.type = type;
...
var wquery_ComponentTools = $hx_exports["wquery"]["ComponentTools"] = function() { };
...
var wquery_CssGlobalizer = $hx_exports["wquery"]["CssGlobalizer"] = function(klassName) {
...
var wquery_Event = $hx_exports["wquery"]["Event"] = function() {
	this.handlers = [];
};
...
var wquery_EventTools = $hx_exports["wquery"]["EventTools"] = function() { };
...
var wquery_Template = $hx_exports["wquery"]["Template"] = function(klass) {
